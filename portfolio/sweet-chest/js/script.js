...
document.addEventListener('DOMContentLoaded', function (e) {
  ...
  var lazyImages = document.querySelectorAll('.lazy-load'); // options
  ...
  var options = {
    ...
    rootMargin: '0px',
    // Отступы вокруг root
    treshold: 1 // Число, указывающие, при каком проценте видимости целевого элемента должен сработать callback
  ...
  function loadImg(img) {
    img.src = img.dataset.src; // for webp
